...
```
docker images
docker tag app-node your-usename/app-node:latest
docker login
docker push your-usename/app-node:latest
```
    ...
    steps:
      ...
      - name: Build and push Docker image
        ...
        with:
          ...
          push: true
          tags: |
            your-usename/app-node:${{ github.sha }}
...
```
docker pull your-usename/app-node:66c3b6f8e01090562913da81e918be9e06f1e045
docker images
docker ps
docker run -d -p 3300:3000  your-usename/app-node:66c3b6f8e01090562913da81e918be9e06f1e045
docker ps
```
- Go to browser http://localhost:3300/
